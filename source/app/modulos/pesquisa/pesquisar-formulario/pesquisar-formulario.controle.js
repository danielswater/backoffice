(function() {
	...
	define(['angularAMD', 'dirPagination', './recurso.js'], function(app) {
		...
		app.controller('PesquisaFormularioControle', PesquisaFormularioControle)
		
		PesquisaFormularioControle.$inject = ['$scope', '$rootScope', '$uibModal','FiltroRequisicao','RecursoCredito',
			 'MensagensFabrica'
		]
		
		function PesquisaFormularioControle ($scope, $rootScope, $uibModal,FiltroRequisicao,RecursoCredito,
		 MensagensFabrica
            ) {
