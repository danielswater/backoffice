(function() {
	...
	define(['angularAMD', 'dirPagination', 'sptMensagemErro', 'CreditoServico'], function(app) {
		...
		app.controller('PesquisarCreditoControle', PesquisarCreditoControle);

		PesquisarCreditoControle.$injector = ['$scope', '$rootScope', '$uibModal',
		'FiltroRequisicao',
		'MensagensFabrica',
		'CreditoServico'
	...
	function PesquisarCreditoControle($scope, $rootScope, $uibModal,
				...
				CreditoServico.filtrar(
					...
					function(resultado){
						...
						if(resultado.data.length == 0 ){
							...
							console.log($scope.creditos.length);
