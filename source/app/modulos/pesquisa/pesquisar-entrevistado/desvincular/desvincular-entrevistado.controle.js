define(['angularAMD', 'sptMensagemErro'], function(app) {
	app.controller('DesvincularEntrevistadoControle', DesvincularEntrevistadoControle);

	DesvincularEntrevistadoControle.$inject = ['$scope', '$uibModalInstance', 'modal', 'MensagensFabrica'];

	function DesvincularEntrevistadoControle($scope, $uibModalInstance, modal, MensagensFabrica) {
