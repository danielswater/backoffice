define(['angularAMD'], function(app) {
	app.controller('ExcluirPerfilControle', ExcluirPerfilControle);
		ExcluirPerfilControle.$inject = ['$scope', '$rootScope', '$http','$uibModalInstance', 'modal', 'ModalFabrica', 'PerfilUsuarioServico', 'MensagensFabrica'
	];


				function ExcluirPerfilControle($scope, $rootScope, $http, $uibModalInstance, modal, ModalFabrica, PerfilUsuarioServico, MensagensFabrica
			) {
	...
	console.log(modal.objeto.id);
			...
			$scope.excluir = function() {
			$scope.espera = PerfilUsuarioServico.deletar(
				modal.objeto.id,
