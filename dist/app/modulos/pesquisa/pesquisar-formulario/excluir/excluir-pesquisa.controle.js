define(['angularAMD', 'sptMensagemErro'], function(app) {
	app.controller('ExcluirPesquisaControle', ExcluirPesquisaControle);

	ExcluirPesquisaControle.$inject = ['$scope', '$uibModalInstance', 'modal', 'MensagensFabrica'];

	function ExcluirPesquisaControle($scope, $uibModalInstance, modal, MensagensFabrica) {
