define(['angularAMD'], function(app) {
	app.controller('IncluirMenuPaginaPrincipalControle', IncluirMenuPaginaPrincipalControle);
	IncluirMenuPaginaPrincipalControle.$inject = ['$scope', '$rootScope', '$http','$uibModalInstance', 'modal', 'ModalFabrica'];

	function IncluirMenuPaginaPrincipalControle($scope, $rootScope, $http, $uibModalInstance, modal, ModalFabrica) {
		$scope.modal = modal;
		$scope.incluir = {
			imagem : '',
			corFundo : '#000000',
