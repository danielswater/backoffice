define(['angularAMD'], function(app) {
	app.controller('AprovarFormularioControle', AprovarFormularioControle);

	AprovarFormularioControle.$inject = ['$scope', '$uibModalInstance', 'modal'
	];

	function AprovarFormularioControle($scope, $uibModalInstance, modal
		) {
